/*
  # Recreate Comics and Wishlist Tables

  ## Overview
  This migration recreates the comics and wishlist tables that were accidentally removed.
  These tables are essential for the QuickStack comic tracker application.
  ...
  - `copy_count` (integer) - Number of copies owned
  ...
  - Includes all columns from previous migrations (cover images, copy count)
*/
