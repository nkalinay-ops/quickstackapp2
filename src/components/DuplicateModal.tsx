    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 p-4 flex items-center justify-between">
          <h2 className="text-xl font-semibold text-gray-900">Duplicate Comic Detected</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div className="space-y-3">
              ...
              <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                <p className="font-medium text-gray-900">{existingComic.title}</p>
                <p className="text-sm text-gray-600">Issue #{existingComic.issue_number}</p>
                {existingComic.publisher && (
                  <p className="text-sm text-gray-600">{existingComic.publisher}</p>
                )}
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={isProcessing}
              className="w-full bg-gray-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
